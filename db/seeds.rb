...
pt = Area.find_or_create_by(name: "Pallet Town", north_area_id: 2, south_area_id: nil, pokemon_list: town)
r1 = Area.find_or_create_by(name: "Route 1", north_area_id: 3, south_area_id: 1, pokemon_list: r1_pokemon)
vc = Area.find_or_create_by(name: "Veridian City", north_area_id: 4, south_area_id: 2, pokemon_list: town)
