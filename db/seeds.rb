...
JournalEntry.create(student_id: 1, lecture_id: 2, date_created: 2020-01-28, what_did_i_learn: "Ruby nay", what_was_unclear: "It has gems?", confidence_level: 1, feelings_on_topic: "Fruit is not a grape", feelings_general: "Miss Jackson", mood: "truck nuts")
JournalEntry.create(student_id: 1, lecture_id: 3, date_created: 2020-01-29, what_did_i_learn: "Use attr_accessor", what_was_unclear: "How to make a deck of cards", confidence_level: 5, feelings_on_topic: "I like typing less. Das ist gut.", feelings_general: "hungry", mood: "scared/excited")
